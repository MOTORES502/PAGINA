...
(function (e) {
    e.extend(e.fn, {
        ...
        messages: {
            ...
            url: "Por favor ingregar una URL válida.",
            date: "Por favor ingresar la fecha.",
            dateISO: "La fecha no tiene formato correcto.",
            number: "Por favor ingrese un número válido.",
            digits: e.validator.format("Por favor ingreso un número con la cantidad de {0} dígitos."),
