...
use App\Models\Empresa\Advance;
...
class Reservation extends Model
{
    ...
    protected $fillable = [
        'code', 'plate_number', 'price_negotiate', 'resta', 'shipping',
        'code_auto', 'minuta',

        'coins_id', 'brands_id', 'lines_id', 'generations_id', 'models_id', 'versions_id',
        'colors_id', 'type_plates_id', 'people_id', 'users_id', 'vehiculo_costo_id'
    ];
    ...
    {
        return $this->hasMany(Advance::class, 'reservations_id', 'id');
    }
}
