                    ...
                    <div class="car-compare-header">
                        <div class="header-outer clearfix">
                            ...
                            <div class="car-column">
                                <div class="inner">
                                    <figure class="image">
                                        <img alt="{{ $image_one->concat }}" class="lazyload" data-src="{{ Storage::disk('images')->url($image_one->image) }}" />
                                    </figure>
                                    <div class="title-box">
                            ...
                            <div class="car-column">
                                <div class="inner">
                                    <figure class="image">
                                        <img alt="{{ $image_two->concat }}" class="lazyload" data-src="{{ Storage::disk('images')->url($image_two->image) }}" />
                                    </figure>
                                    <div class="title-box">
                    ...
                    <div class="car-info-block">
                        <div class="info-inner">
                            ...
                            <div class="info-row clearfix">
                                ...
                                <div class="info-col">{{ number_format($vehiculo_one->mileage, 0, '.', ',') }} Kms</div>
                                <div class="info-col">{{ number_format($vehiculo_two->mileage, 0, '.', ',') }} Kms</div>
                            </div>
                            <div class="info-row clearfix">
