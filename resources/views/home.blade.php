        ...
        <div class="row clearfix">
            <div class="column col-lg-5 col-md-12 col-sm-12 col-xs-12">
                <div class="row clearfix">
                    ...
                    <div class="form-group col-md-6">
                        <select id="marca_id" name="marca_id" class="ui-selectmenu-button ui-selectmenu-button-closed js-example-basic-single">
                    ...
                    <!--Form Group-->
                    <div class="form-group col-md-6">
                        <select id="linea_id" name="linea_id" class="ui-selectmenu-button ui-selectmenu-button-closed js-example-basic-single">
            ...
            <div class="column col-lg-5 col-md-12 col-sm-12 col-xs-12">
                <div class="row clearfix">
                    <!--Form Group-->
                    <div class="form-group col-md-6">
                        <select name="precio_minimo" class="ui-selectmenu-button ui-selectmenu-button-closed js-example-basic-single">
                    ...
                    <!--Form Group-->
                    <div class="form-group col-md-6">
                        <select name="precio_maximo" class="ui-selectmenu-button ui-selectmenu-button-closed js-example-basic-single">
